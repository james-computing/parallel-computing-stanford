...
extern "C" {
#endif // __cplusplus
    extern void ispc_sinx_abstract(const uint32_t N, const uint32_t terms, const float * x, float * result);
    extern void ispc_sinx_blocks(const uint32_t N, const uint32_t terms, const float * x, float * result);
    extern void ispc_sinx_interleaved(const uint32_t N, const uint32_t terms, const float * x, float * result);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
